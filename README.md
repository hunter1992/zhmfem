...
which contains the calculation code for Solution A.

#### Computational code programming for Solution A
...
After cloning ZHMFEM, you can find the *quad2d4n.rs* file in the “zhmfem/examples/” path, 
which contains the calculation code for Solution B.

#### Computational code programming for Solution B

The code in *quad2d4n.rs* under “zhmfem/examples/”:
